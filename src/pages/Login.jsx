  ...
  return (
    ...
    <form className='flex flex-col  shadow-lg max-w-[424px] rounded-md mx-auto border border-gray-100 dark:border-primary lg:my-22 my-10'>
      ...
      <div className='px-8 flex flex-col gap-4 py-6'>
        <div className=''>
          <span className='font-inter text-tcolor block font-semibold pb-2 dark:text-gray-300 select-none'>Email Address</span>
          <input type="email" className='w-full border border-gray-200 rounded-sm outline-0 py-2 px-3 dark:placeholder:text-gray-300' placeholder='Enter Your Email'/>
        </div>
        <div className=''>
          <div className='flex justify-between'>
            <span className='font-inter text-tcolor block font-semibold pb-2 dark:text-gray-300 select-none'>Password</span>
             <span className='text-[#0e78c4]  font-inter text-[14px] leading-6 cursor-pointer formTxtHover tracking-wide select-none'>Forgotten Password?</span>
          </div>
          <div className='relative'>
            <input type={show ? "text" : "password"} className='w-full border border-gray-200 rounded-sm outline-0 py-2 px-3 dark:placeholder:text-gray-300' placeholder='Enter Your Password'/>
            {show ? 
