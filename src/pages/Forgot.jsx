                ...
                <div className='px-8 flex flex-col gap-4'>
                    <div className=''>
                        <div className='flex justify-between'>
                            <label htmlFor='email' className='font-inter text-tcolor dark:text-gray-100 block font-semibold pb-2 dark:text-gray-300 select-none'>Email</label>
                        </div>
                        <input 
                            type="email" 
                            id='email'
                            ...
                            className={`w-full border rounded-sm outline-0 py-2 px-3 dark:placeholder:text-gray-300 inputRing ${errs.email ?'border-2 border-red-400 placeholder:text-red-500' : 'border-gray-200 dark:border-[#333333]'}`} 
                    ...
                    <div className='pb-7 w-full'>
                        <h1 className='text-[15px] text-tcolor dark:text-gray-100 font-inter dark:text-gray-300 text-center lg:text-left'>You may contact <Link to='/customer-services' className='text-[#FA8232] hover:underline'>Customer Services</Link> for help restoring access to your account</h1>
                    </div>
                </div>
            </form>
        </main>
