            ...
            <Container>
                <div className='flex pt-8 w-full gap-5'>
                    <div className='flex flex-col gap-6 w-[322px]'>
                        <span className='font-inter text-[18px] font-semibold dark:text-gray-200 text-tcolor dark:text-gray-100 tracking-widest'>
                            SUPPORT
                        </span>
                        <div className='flex flex-col gap-5'>
                            <Link to='tel:16793' className='rounded-full w-[245px] h-18 flex gap-10 items-center border border-gray-200 dark:border-[#333333] hover:border-primary dark:border-primary dark:hover:border-red-600'>
                                ...
                                <div className='relative w-40 after:absolute after:content-[""] after:h-10 after:w-[1px] after:top-1 after:-left-7 after:bg-gray-300 flex flex-col cursor-pointer'>
                                    <span className='text-[14px] text-gray-500 dark:text-gray-400 dark:text-gray-300'>9 AM - 8 PM</span>
                                    <span className='font-bold text-[20px] text-tcolor dark:text-gray-100 dark:text-[#ef3023e5]'>16793</span>
                                </div>
                            </Link>
                            <Link to='mailto:electromart@gmail.com' className='rounded-full w-[245px] truncate h-18 flex gap-10 items-center border border-gray-200 dark:border-[#333333] dark:hover:border-red-600 dark:border-primary hover:border-primary'>
                                <Mail size={23} className='ml-6' />
                                <div className='relative w-40 after:absolute after:content-[""] after:h-10 after:w-[1px] after:top-1 after:-left-7 after:bg-gray-300 flex flex-col cursor-pointer'>
                                    <span className='text-[14px] text-gray-500 dark:text-gray-400 dark:text-gray-300'>Contact via mail</span>
                                    <span className='font-bold text-[18px] text-tcolor dark:text-gray-100 truncate dark:text-[#ef3023e5]'>electromart@gmail.com</span>
                                </div>
                            </Link>
                        </div>
                    </div>
                    <div className='flex flex-col gap-6 w-[645px]'>
                        <span className='font-inter text-[18px] font-semibold text-tcolor dark:text-gray-100 tracking-widest dark:text-gray-300'>
                            ABOUT US
                        </span>
                    ...
                    <div className='flex flex-col gap-6 w-[322px]'>
                        <span className='font-inter text-[18px] dark:text-gray-200 font-semibold text-tcolor dark:text-gray-100 tracking-widest'>
                            STAY CONNECTED
                        </span>
                        <div>
                            <div className='flex flex-col gap-1 pb-1'>
                                <span className='font-semibold text-[16px] leading-7 dark:text-gray-200'>Electro Tech Ltd</span>
                                <span className='font-inter text-tcolor dark:text-gray-100 pr-8 dark:text-gray-300'>Head Office: 28 roadd fslkd lksdjfl lskdf lskdf lksdjfl sf, Dhaka 1000</span>
                            </div>
                            <div className='flex flex-col gap-1'>
                                <span className='text-gray-500 dark:text-gray-400 font-semibold dark:text-gray-200'>
                                    Email:
                                </span>
                ...
                <div className='flex justify-between py-4'>
                    ...
                    <div className='flex text-[14px] leading-7 font-inter text-gray-500 dark:text-gray-400 items-center gap-4'>
                        ...
                        <div className='flex gap-2'>
                            <div className='flex gap-2 items-center py-1 px-2 rounded active:bg-gray-200
                                ...
                                <div className='text-white font-pop flex flex-col gap-1 leading-none'>
                                    <span className='text-gray-500 dark:text-gray-400 text-[12px] dark:text-gray-300'>Download on the</span>
