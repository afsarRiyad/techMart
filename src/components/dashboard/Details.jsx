  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-2xl darkbg">
      ...
      <div className="mb-6 mt-10">
        <h2 className="font-inter text-2xl text-tcolor darkH">Password change</h2>
      ...
      <div className="mb-6">
        ...
        <input
          ...
          className="inputRing w-full rounded-full border border-gray-300 bg-white px-5 py-3 font-inter text-[15px] text-tcolor outline-none transition-all duration-200 dark:border-gray-700 dark:bg-[#222] darkH"
        />
        <div className="mt-3">
      ...
      <div className="mb-6">
        ...
        <p className="mt-3 font-inter text-[13px] text-gray-500 darktxt">
      ...
      <div className="mb-8">
        ...
        <input
          ...
          className={`inputRing w-full rounded-full border bg-white px-5 py-3 font-inter text-[15px] text-tcolor outline-none transition-all duration-200 dark:bg-[#222] darkH ${
        ...
        {!passwordsMatch && (
          ...
          className={`rounded-full px-8 py-3 font-inter text-sm font-semibold transition-all duration-300 ${
            canSave
              ? "bg-primary text-tcolor hover:brightness-95 cursor-pointer"
