...
import watchess from '@/assets/images/smartwatch-slider.webp'
...
const HeroSlider = () => {
  ...
  return (
    <>
 {/* the slides are photographs with light backgrounds, so the text stays dark in
     both themes; `dark:text-tcolor` keeps the price and the buttons dark too */}
 <div  style={{backgroundImage: `url(${activeIndex === 1 ? ProductBackground : background})`}} className='relative w-full h-[240px] lg:h-[410px] bg-gray-100 dark:bg-[#1c1c1c] dark:text-tcolor bg-center transition-all duration-500 bg-cover overflow-hidden'>
    <Container>
        <Swiper 
        slidesPerView={1}
        spaceBetween={30}
