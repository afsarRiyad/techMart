...
import { featureData } from '@/components/home/features/featureData'
import FeatureCard from '@/components/home/features/FeatureCard'

const Features = () => {
    return (
        <Container>
    <div className='overflow-x-auto scroll-x-auto font-inter scroll-smooth overflow-y-hidden touch-auto select-none min-w-0'>
