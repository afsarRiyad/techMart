...
import { setSelectedBrands, setSelectedColors, setPriceRange } from '../../features/products/productPageSlice' 
...
const ProSidebar = ({active, setActive, activeChild, setActiveChild}) => {
    const dispatch = useDispatch()
